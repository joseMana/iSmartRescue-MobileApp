    ...
    d.AmLegend = d.Class({
        ...
        addListeners: function (a, b) {
            ...
            a && a.mouseover(function (a) {
                ...
                c.clickMarker(b, a, b.value);//Seph Intrude
        ...
        clickMarker: function (a, b, c) {
            this.switchable && (!0 === a.hidden ? document.getElementById("totalexpense").innerHTML = parseFloat(document.getElementById("totalexpense").innerHTML) + c : document.getElementById("totalexpense").innerHTML = parseFloat(document.getElementById("totalexpense").innerHTML) - c)//Seph Intrude
